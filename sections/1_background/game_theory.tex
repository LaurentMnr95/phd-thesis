...
\begin{itemize}
    \item \textbf{deterministic strategies:} the player plays a fixed strategy $x$ (for Player 1) or $y$ (for Player 2). 
...
\end{align*}
We can then come to a necessary and sufficient conditions for the existence of Nash equilibria in the case of a two-player zero-sum game:
\begin{align*}
