...
\begin{figure}
    ...
    \begin{minipage}{0.25\linewidth}
    \centering
    \includegraphics[width=0.85\linewidth]{images/regret_cost_attacks_context/jester/cost_context_attack_jester.pdf}
    % \caption{Jester}
    \end{minipage}\hfill
    \begin{minipage}{0.25\linewidth}
    \centering
    \includegraphics[width=0.85\linewidth]{images/regret_cost_attacks_context/movielens/cost_context_attack_movielens.pdf}
    % \caption{MovieLens}
    \end{minipage}
